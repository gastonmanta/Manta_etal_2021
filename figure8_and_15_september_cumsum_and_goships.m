...
print(gcf, '-depsc','-painters' ,'-r600','figure8_september')

 savefig('figure3c_horizontal_transport')

print(gcf, '-dpdf','-r600','figure8_september')
print(gcf, '-djpeg','-r600','figure8_september')
print(gcf, '-dpng','-r600','figure8_september')
% 
...
th=m_annotation('textarrow',[-27 -27],[-34.8 -32.5],'String','0.10 PW','color', [0.6 0 0]);
...
th=m_annotation('textarrow',[-2 -2],[-34.8 -32],'String','0.27 Sv','color',[0 0.4 0]);
...
m_grid('xtick',[-60:10:20],'xticklabels',[])
...
set(gcf,'color','w');
  ...
  print(gcf, '-djpeg','-r600','/Users/gaston/Documents/Phd/Datos_CTD_phd/Johannes_Merian/output_figures_merian/figure_9_merian')
% 
